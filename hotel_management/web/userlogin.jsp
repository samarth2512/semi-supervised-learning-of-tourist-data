                ...
                <td width="50%" 
                    ...
                    <table class="style3">
                       ...
                       <tr>
                        ...
                        <tr>
                            <td align="center">
                                <input type="text" placeholder="  Password"  name="pass"
                                   Class="intLog" style="font-size:Large;height:30px;width:230px;"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="left">
                        ...
                        <tr>
                            <td align="center">
                                <input type=button name="login" value="login" Font-Bold="False" style="font-size:14pt;font-weight:normal;font-family: calibri" OnClick="validation()" />
                                <a href="register.jsp"><b>create the account</b></a>
                            </td>
                        </tr>
                        <tr>
                            <td align="center">
