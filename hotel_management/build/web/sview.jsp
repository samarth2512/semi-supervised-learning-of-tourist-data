			...
			Statement st =conn.createStatement();
                        ...
                        //ResultSet rs = st.executeQuery("select * from recommend where uname='"+user+"'");
                         ResultSet rs2 = st.executeQuery("select * from add_hotel");
                               ...
                               <option value="<%=rs2.getString("hname")%>"><%=rs2.getString("hname")%></option>
...
String output="";
                       ...
                       output=(String)session.getAttribute("g");
                        ...
                        double[] cr1 = new double[3];
                         ...
                         ResultSet rs1 = st.executeQuery("select * from tcounts where hname='"+output+"'");
                                    ...
                                    cr1[0]=rs1.getDouble("positive");
                                    cr1[1]=rs1.getDouble("negative");
                                    cr1[2]=rs1.getDouble("newtural");
                                    }
            ...
            System.out.println("values: "+ cr1.length);
                       ...
                       XYChart c = new XYChart(400,350); //750, 600
                        ...
                        c.xAxis().setTitle("review each hotel", "Arial Bold Italic", 12);
                   ...
                   <map name="map1"><%=imageMap1%></map>
                            ...
                            <td><a href="opiegraph.jsp">click here</a></td>
                        </tr>
                        <tr>
                            <td align="center">
                                &nbsp;</td>
